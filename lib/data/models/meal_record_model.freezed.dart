...
mixin _$MealRecordModel {
  ...
  double get proteins => throw _privateConstructorUsedError; // Нове
  double get fats => throw _privateConstructorUsedError; // Нове
  double get carbs => throw _privateConstructorUsedError; // Нове
...
class _$MealRecordModelImpl implements _MealRecordModel {
  ...
  @override
  String toString() {
    return 'MealRecordModel(id: $id, foodName: $foodName, calories: $calories, proteins: $proteins, fats: $fats, carbs: $carbs, date: $date, mealType: $mealType)';
  }
...
abstract class _MealRecordModel implements MealRecordModel {
  ...
  int get calories;
  @override
  double get proteins; // Нове
  @override
  double get fats; // Нове
  @override
  double get carbs; // Нове
  @override
  DateTime get date;
  @override
