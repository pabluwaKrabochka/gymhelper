...
import 'package:gymhelper/features/profile/screens/profile_screen.dart';
import 'package:iconsax_plus/iconsax_plus.dart';

import 'package:gymhelper/core/theme_cubit.dart'; // ПЕРЕВІР ШЛЯХ ДО THEME CUBIT
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ThemeCubit, ThemeMode>(
      builder: (context, themeMode) {
        ...
        // Зверни увагу: прибрали const, щоб екрани миттєво підхоплювали зміну теми
        final screens = [
          HomeScreen(),
          AnalyticsScreen(),
          GameScreen(), 
        ...
        // --- МАГІЯ ПЛАВНОСТІ ---
        // Цей AnimatedContainer робить плавний перехід фону для ВСЬОГО додатку
            ...
            bottomNavigationBar: SafeArea(
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    AnimatedContainer( // Анімуємо зміну кольору нижньої панелі
                      duration: const Duration(milliseconds: 500),
                        ...
                        child: BackdropFilter(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(tablet ? 40 : 30),
                              border: Border.all(color: AppColors.textSecondary.withAlpha(40), width: 1.5),
                            ),
                            child: Row(
